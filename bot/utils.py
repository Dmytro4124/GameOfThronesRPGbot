...
async def send_safe_message(bot: Bot, chat_id: int, text: str, reply_to_message_id: int = None, reply_markup=None):
...
async def send_game_response(bot: Bot, chat_id: int, text: str, suggested_actions: list = None,
    ...
    await send_safe_message(bot, chat_id, text, reply_to_message_id=reply_to_message_id, reply_markup=markup)